	...
	<div ng-controller="headerController"
		...
		<nav class="white nav1">
			<div class="nav-wrapper">
				<a href="" class="logo"> <em class="em1">鲁大</em> <em class="em2">二手工坊</em>
					<em class="em3">ldu.market</em> </a>
				<div class="nav-wrapper search-bar">
					<form ng-submit="search()"
						class="ng-pristine ng-invalid ng-invalid-required">
						<div class="input-field">
							<input id="search" type="search" ng-model="keyword"
								placeholder="搜点什么吧233..." required="required"
								class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" />
							<label for="search" class="active"> <i
								ng-click="search()" class="iconfont"></i> </label>
						</div>
					</form>
				</div>
				<ul class="right">
						...
						<li class="changemore"><a class="changeMoreVertShow()"> <i
							...
							<div class="more-vert">
								<ul class="dropdown-content">
									...
									<li><a onclick="ChangeName()">更改用户名</a>
									</li>
									<li><a href="/user/logout">退出登录</a>
									</li>
								</ul>
							</div></li>
					</c:if>
...
-->
	<div ng-controller="sidebarController"
		...
		<li ng-class="{true: 'active'}[isAll]"><a href="" class="index">
				<img src="img/index.png"> <em>最新发布</em> </a></li>
		<li ng-class="{true: 'active'}[isDigital]"><a href=""
			class="digital"> <img src="img/digital.png" /> <em>闲置数码</em> </a></li>
		<li ng-class="{true: 'active'}[isRide]"><a href="" class="ride">
				<img src="img/ride.png" /> <em>校园代步</em> </a></li>
		<li ng-class="{true: 'active'}[isCommodity]"><a href=""
			class="commodity"> <img src="img/commodity.png" /> <em>电器日用</em>
		</a></li>
		<li ng-class="{true: 'active'}[isBook]"><a href="" class="book">
				<img src="img/book.png" /> <em>图书教材</em> </a></li>
		<li ng-class="{true: 'active'}[isMakeup]"><a
			href="/category/makeup" class="makeup"> <img src="img/makeup.png" />
				<em>美妆衣物</em> </a></li>
		<li ng-class="{true: 'active'}[isSport]"><a
			href="/category/sport" class="sport"> <img src="img/sport.png" />
				<em>运动棋牌</em> </a></li>
		<li ng-class="{true: 'active'}[isSmallthing]"><a href=""
			class="smallthing"> <img src="img/smallthing.png" /> <em>票券小物</em>
		</a></li>
		<div class="info">
		...
		<div class="slider-wapper">
			<div class="slider"
				...
				<ul class="slides" style="height: 400px;">
					<li class="active" style="opacity: 1;"><a href=""> <img
							src="img/findfun.png" /> </a></li>
				</ul>
				<ul></ul>
			</div>
		</div>
				...
				<div class="card col">
					<a href="">
						<div class="card-image"
							style="background-image:url(img/file-1493726053986.JPG)"></div>
