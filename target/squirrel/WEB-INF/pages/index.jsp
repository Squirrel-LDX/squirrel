...
<head>
	...
	<script>
        ...
        function ChangeName() {
            if($("#changename-show").css("display")=='none'){
                $("#changename-show").css("display","block");
            }else{
                $("#changename-show").css("display","none");
            }
        }
	</script>
...
<div ng-controller="changeNameController" class="ng-scope">
	<div id="changename-show" class="change-name stark-components">
		<div class="publish-box z-depth-4">
			<div class="row">
				...
				<div class="input-field col s12">
					<input type="text" name="username" required="required" class="validate ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required">
					<label>新用户名</label>
				</div>
